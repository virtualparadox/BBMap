...
public final class MultiStateAligner9PacBio extends MSA{
	...
	public static void main(String[] args){
		...
		MultiStateAligner9PacBio msa=new MultiStateAligner9PacBio(read.length, ref.length, colorspace);
	...
	public MultiStateAligner9PacBio(int maxRows_, int maxColumns_, boolean colorspace_){
...
//			assert(false) : div;
	...
	public static final int POINTS_SUB=-137; //default -133
	public static final int POINTS_SUBR=-157; //increased penalty if prior match streak was at most 1 (I have no idea why this improves things)
	...
	public static final int POINTS_INS=-205; //default -395
	...
	public static final int POINTS_DEL=-292; //default -472
	public static final int POINTS_DEL2=-37; //default -30
	public static final int POINTS_DEL3=-17; //default -7
	public static final int POINTS_DEL4=-2; //default -1
