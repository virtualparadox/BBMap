...
//			}
	...
	public static class ReadComparatorMapping implements Comparator<Read> {
...
//			if(a.stop!=b.stop){return a.stop-b.stop;}
	...
	private class RegenMatchThread extends Thread{
		...
		private void regenMatchString(Read r){
			assert(r.match==null);
//			(final Read r, final int padding, final boolean recur, final int minValidScore){
			tcr.realign_new(r, 4, true, 0, false);
