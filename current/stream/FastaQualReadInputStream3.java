...
public class FastaQualReadInputStream3 extends ReadInputStream {
	
	public static void main(String[] args){
		
		FastaQualReadInputStream3 fris=new FastaQualReadInputStream3(args[0], args[1], false, true);
	...
	public FastaQualReadInputStream3(String fname, String qfname, boolean colorspace_, boolean allowSubprocess_){
		this(FileFormat.testInput(fname, FileFormat.FASTA, null, allowSubprocess_, false), qfname, colorspace_);
	}
	
	public FastaQualReadInputStream3(FileFormat ff, String qfname, boolean colorspace_){
