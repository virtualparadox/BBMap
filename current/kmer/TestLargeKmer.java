...
public class TestLargeKmer {
	...
	public static long[] countK2(String fname1, String fname2, int k, KCountArray2 counts1, int k2){
		...
		FastqReadInputStream fris1=new FastqReadInputStream(fname1, false, false);
		FastqReadInputStream fris2=(fname2==null ? null : new FastqReadInputStream(fname2, false, false));
